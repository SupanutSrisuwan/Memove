...
<div id="post-wrap">
    ...
    <div>
        ...
        @elseif($order->status === 'in progress')
            <img src="{{ url('') }}/img/order.png" style="width:100%;" alt="order detail" >
        @elseif($order->status === 'cancel')
            <img src="{{ url('') }}/img/3948356.jpg" style="width:100%;" alt="order detail" >
        @elseif($order->status === 'pending:success')
        <img src="{{ url('') }}/img/4752200.jpg" style="width:100%;" alt="order detail" >
        @else 
    ...
    <div class=" mt-4">
            ...
            <img src="{{ url('') }}/img/detail.png" class="p-5" style="width:100%;" alt="order detail" >
            ...
            <div class="mt-5 pt-5 fixed-bottom" style="bottom:3%;">
                <div class="row pl-3 pr-3 mt-5 pt-5">
                    ...
                    <div class="col-12 mt-5">
                        <a href="/report">
                            <button class="btn btn-block p-3" style="font-size:20px;background: #E93F3F;color:#fff;box-shadow: 0px 1px 10px rgba(0, 0, 0, 0.25);border-radius: 10px;">
                                แจ้งปัญหา
                            </button>
                        </a>
                    </div>
